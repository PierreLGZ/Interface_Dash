...
index_page = html.Div(
    ...
    children=[
        ...
        #html.Br(),
        html.Div([
            html.H6("Sélectionner la variale à prédire : "),
            html.Div([
                dcc.Dropdown(
            ...
            html.H6("Sélectionner la ou les variables explicatives : "),
            dcc.Dropdown(
                id='id_var_expli',
                options=[],
                multi=True
...
page_1_layout = html.Div(
    ...
    children = [
            html.Div([
                html.Div([
                    html.H1(id="id_nom_algo1", children="Resultats pour l'algorithme N°1"),
            ...
            html.Button('Afficher', id='submit_val_PAGE1', n_clicks=0),
...
page_2_layout = html.Div(
    ...
    children=[
        html.Div([
            html.Div([
                html.H1(id="id_nom_algo2", children="Resultats pour l'algorithme N°2"),
            ], style={'width': '50%', 'display': 'inline-block'}),
            html.Div([
                html.A("RésultatsAlgo3", href='/page-3', target="_blank"),
            ], style={'display': 'inline-block', "margin-left": "1200px"}),
...
page_3_layout = html.Div(
    ...
    children=[
        html.Div([
            html.Div([
                html.H1(id="id_nom_algo3", children="Resultats pour l'algorithme N°3"),
            ], style={'width': '50%', 'display': 'inline-block'}),
            #html.Div([
            #    html.A("Retour_Page_Principale", href='Page_Principale', target="_blank"),
            #], style={'display': 'inline-block', "margin-left": "1200px"}),
...
def update_dropdown(id_var_cible,content):
    ...
    return [{"label": i, "value": i} for i in var_expli2]
...
def get_model(button_valid, varCible, ModeleML):  # X, y, type_model, nom_model, param_depart
    ...
    if type_model == 'classif':
        ...
        print(precision_score(y_test, y_pred, average='micro'),
              # Ajout autre average ? Comprendre ce que c'est : https://stackoverflow.com/questions/52269187/facing-valueerror-target-is-multiclass-but-average-binary
...
def get_model1(button_valid,donnees,varCible,var_explis,ModeleML,type_model):  # X, y, type_model, nom_model, param_depart   var_explis
    ...
    if 'submit_val_PAGE1' in changed_id:
        ...
        titre_page = "Resultats pour l'algorithme de " + str(ModeleML)
